...
\subsubsection{Équation du mouvement et variables dynamiques} %TODO: completer aussi. je sais pas quoi inclure et ne pas inclure
...
\begin{itemize}
	...
	\item (b) le choc est instantané. L'oeuf se casse (probablement).
\end{itemize}
...
Vraiment, ces intégrales ne sont pas très importantes au niveau des calculs. Je n'intégrerai donc que peu des résultats intermédiaires qui en comprennent, et tenterai de présenter uniquement les formules applicables et la façon de les appliquer.
